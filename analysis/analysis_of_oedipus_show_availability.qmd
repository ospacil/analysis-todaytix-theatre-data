---
title: "Oedipus theatre show - Analysis of seat availability"
...
Even this crude table visualization uncovers a coupld of curious observations:
...
2. **Some performances later in the show run do not have the "full" number of data points.** We shall have a look at detail, but it seem that we might be missing some of the daily data points for these performances.

### Missing daily data points

Actually, I am pretty sure the missing dates are the dates on which there are 0 seats available for the perofmance! This is quite important to know... 
TODO: Verify the above, and fill in the missing dates.
